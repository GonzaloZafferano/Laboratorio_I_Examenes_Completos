...
static void imprimirErrores(int codigoError)
{
	...
	switch(codigoError)
	{
		...
		case -25:
			...
			break;
		case -26:
			strncpy(mensaje,"\n\t\t--ERROR. No se pudo llevar a cabo ninguna actualizacion!--\n\t\t--Todos los arcades estan proximos al limite de fichas!--\n" , LEN_MENSAJE);
			break;
		case -27:
			strncpy(mensaje,"\n\t\t--ERROR. No se pudieron imprimir todos los elementos!.--\n" , LEN_MENSAJE);
			break;
			///////////////////////////ERRORES RELACIONADOS CON ABM
		case -30:
			strncpy(mensaje,"\n\t\t<--Un momento! La lista se encuentra vacia! No se puede operar esta opcion!.-->"
					"\n\t\t<--Genere altas (Op. 2) para poder operar-->\n", LEN_MENSAJE);
			break;
		case -31:
			strncpy(mensaje,"\n\t\t<--Un momento! Hay un solo Arcade en la lista! No se puede ordenar!-->\n", LEN_MENSAJE);
			break;
		case -32:
		...
		case -34:
			...
			break;
		case -35:
			strncpy(mensaje,"\n\t\t--ERROR. No se aplicaron modificaciones sobre el arcade.--\n", LEN_MENSAJE);
			break;
		case -36:
			strncpy(mensaje,"\n\t\t--ERROR. No se aplicaron bajas en el sistema.--\n", LEN_MENSAJE);
			break;
		case -37:
			strncpy(mensaje,"\n\t\t--ERROR. No se pudieron obtener los datos corretamente para imprimir el arcade.--\n", LEN_MENSAJE);
			break;
		case -38:
			strncpy(mensaje,"\n\t\t--ERROR. No se pudieron obtener los datos del arcade.--\n", LEN_MENSAJE);
			break;
		case -39:
		...
		case -40:
			...
			break;
		case -41:
			strncpy(mensaje,"\n\t\t--ERROR. No se pudo cargar Arcade a la lista!.--\n", LEN_MENSAJE);
			break;
		case -42:
			strncpy(mensaje,"\n\t\t--ERROR. No se pudieron cargar todos los Arcades del archivo a la lista!.--\n", LEN_MENSAJE);
			break;
		case -43:
